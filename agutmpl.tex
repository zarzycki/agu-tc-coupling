...
As the horizontal resolution of general circulation models (GCMs) has increased over the last decade, the simulated climatology of tropical cyclones has improved greatly \citep{Oouchi2006,Bengtsson2007a,Zhao2009,Murakami2012,Manganello2012,Satoh2012,Strachan2013,Zarzycki2014AMIPTCs,Wehner2014}. 

{\color{red} Kevin, add some references/bulk to the next sentence?}

While the climatology of simulated TCs across different climate models is large \cite{Camargo2013CMIP,Walsh2015CLIVAR}, it has also been shown that within individual models, storms also show sensitivity to both the dynamical core (e.g. \citet{ReedSimplePhys,Zhao2012}) as well as the choice of subgrid parameterizations (e.g., \citet{Reed2011CAMPhysics,Lim2014TCconv})
